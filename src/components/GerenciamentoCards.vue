...
<script>
import axios from 'axios'; // Importe o axios se você for fazer requisições HTTP

export default {
  name: 'CadastroProduto', // Dê um nome significativo ao componente
  data() {
    return {
      produto: {
        nome: '',
      ...
      categorias: ['Eletrônicos', 'Roupas', 'Livros', 'Alimentos'], // Exemplo de categorias
      subcategorias: [],
      previewImagem: null
    };
  },
  ...
  methods: {
    async cadastrarProduto() {
      console.log('Dados do produto a serem cadastrados:', this.produto);
      // Aqui você implementaria a lógica para enviar os dados do 'this.produto'
      ...
      //     headers: {
      //       'Content-Type': 'multipart/form-data' // Se você estiver enviando arquivos
      //     }
      //   });
    ...
    limparFormulario() {
      Object.assign(this.produto, this.$options.data().produto);
